...
OBS: A Herança Múltipla pode ser feita de duas maneiaras:
...
OBS: Não importa se a derivação é direto ou indireta. A classe que realizar a herança herdará
