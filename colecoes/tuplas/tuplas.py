...
Tuplas são bastante ṕarecidas com listas.

Existem basicamente duas diferenças básicas.

1 - As tuplas são representadas por parênteses ()

2- As tuplas são imutáveis: Isso significa que ao se criar uma tupla ela não muda. Toda operação em
uma tupla gera uma nova tupla.

# CUIDADO 1: As tiplas são representadas por (), mas veja:
...
# CUIDAADO 2: Tuplas com 1 elemento
...
# Já métodos de Soma*, Valor Máximo*, Valor Mínimo* e Tamanho existem.
